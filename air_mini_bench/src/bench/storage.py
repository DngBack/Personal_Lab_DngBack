...
def load_index(phase_dir: Path) -> dict[str, Any]:
    return read_json(phase_dir / "index.json")


def load_payload(phase_dir: Path, rel_path: str) -> dict[str, Any]:
    return read_json(phase_dir / rel_path)
